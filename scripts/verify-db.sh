...
# Wrapper script for database verification
...
echo "🔍 SPY TA Tracker - Database Verification"
echo "=========================================="
...
if source .venv/bin/activate; then
    ...
    echo "ℹ️ Running database verification..."
    python "$SCRIPT_DIR/verify-production-db.py" "$@"
else
